...
export function Funds() {
    ...
    return (
        <div className="flex flex-col bg-gray-50 min-h-screen">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-green-50 to-green-100 py-8 sm:py-12 md:py-16">
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    <div className="flex flex-col items-start">
                        ...
                        <button 
                            className="mt-6 sm:mt-8 bg-green-600 hover:bg-green-700 text-white text-base sm:text-lg font-medium px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-md flex items-center"
            ...
            {/* Static Cards Section - Responsive Layout */}
            <div className="px-4 sm:px-6 md:px-8 lg:px-12 mt-6">
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6">
                    <Card src={"https://static.vecteezy.com/system/resources/previews/023/785/748/original/wolf-icon-logo-design-vector.jpg"} label={"Animals"}/>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-6 mt-3 sm:mt-4 md:mt-6">
            ...
            {/* Dynamic Fundraisers by Category - Responsive Layout */}
            {categories.map((category) => (
                <div key={category} className="mt-8 md:mt-10 px-4 sm:px-6 md:px-8 lg:px-12">
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-xl sm:text-2xl font-semibold">{category} Fundraisers</h2>
                        <button className="text-green-600 hover:text-green-700 font-medium flex items-center text-sm sm:text-base">
                            View all
                    ...
                    {fundraisers[category]?.length > 0 ? (
                        ...
                        <div className="py-6 sm:py-8 text-center w-full">
            ...
            <div className="bg-gradient-to-r from-green-500 to-green-600 py-8 sm:py-10 md:py-12 my-8 sm:my-12 md:my-16">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
                    <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3 sm:mb-4">Ready to start your own fundraiser?</h2>
                    <p className="text-green-100 text-base sm:text-lg mb-4 sm:mb-6">
                        Join thousands of people making a difference. It takes just a few minutes to get started.
                    </p>
                    <button 
                        className="bg-white text-green-600 hover:bg-gray-100 px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg font-semibold text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
                        onClick={() => navigate('/create')}
                    >
                        Start a Fundraiser
                    </button>
