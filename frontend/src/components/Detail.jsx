 ...
 {showMessageModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
                ...
                <div>
                    <textarea 
                        className="w-full h-40 p-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all resize-none"
                    ...
                    <div className="flex space-x-3 mt-4">
                        <button 
                            className="flex-1 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors flex justify-center items-center"
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
                    <div className="relative h-64 md:h-80">
                        ...
                        <div className="absolute bottom-0 left-0 p-6 text-white">
                            <h1 className="text-2xl md:text-4xl font-bold mb-2 leading-tight">{fundraiser.title}</h1>
                    ...
                    <div className="w-full lg:w-2/3">
                        ...
                        <div className="bg-white rounded-xl shadow-md overflow-hidden mb-8">
                            <div className="flex border-b">
                                <button 
                                    className={`px-6 py-4 font-medium text-sm focus:outline-none ${activeTab === 'story' ? 'text-emerald-600 border-b-2 border-emerald-500' : 'text-gray-500 hover:text-emerald-500'}`}
                                    onClick={() => setActiveTab('story')}
                                >
                                    Story
                                </button>
                                <button 
        className={`px-6 py-4 font-medium text-sm focus:outline-none ${activeTab === 'contact' ? 'text-emerald-600 border-b-2 border-emerald-500' : 'text-gray-500 hover:text-emerald-500'}`}
        onClick={() => setActiveTab('contact')}
    >
        Contact
    </button>
                                <button 
                                    className={`px-6 py-4 font-medium text-sm focus:outline-none ${activeTab === 'donors' ? 'text-emerald-600 border-b-2 border-emerald-500' : 'text-gray-500 hover:text-emerald-500'}`}
                                ...
                                {activeTab === 'story' && (
                                    <div>
                                        ...
                                        <div className="mt-8 p-5 bg-gray-50 rounded-lg border border-gray-200">
                                            <h3 className="text-xl font-semibold text-gray-800 mb-4">Organizers and Beneficiary</h3>
                                            <div className="flex items-center">
                                                <div className="bg-emerald-500 text-white rounded-full w-12 h-12 flex items-center justify-center text-xl font-semibold">
                                                    {fundraiser.name}
                                                </div>
                                                <div className="ml-4">
                                                    <p className="text-lg font-medium text-gray-800">{fundraiser.name}</p>
                                                    <p className="text-gray-600">{fundraiser.email}</p>
                                                    {upiId && <p className="text-gray-600">UPI: {upiId}</p>}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{activeTab === 'contact' && (
        <div className="py-8 text-center">
            <MessageSquare size={64} className="mx-auto text-emerald-500 mb-4" />
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Connect with Fundraiser</h3>
            <p className="text-gray-600 mb-6">
                Have a question or want to show support? Send a message directly to the fundraiser.
            </p>
            <button 
                onClick={() => setShowMessageModal(true)}
                className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors flex items-center justify-center mx-auto"
            >
                ...
                <div className="space-y-4">
                    {fundraiser.donors.map((donor, index) => (
                        <div key={index} className="flex items-center p-3 bg-gray-50 rounded-lg">
                            <div className="bg-emerald-100 text-emerald-600 rounded-full w-10 h-10 flex items-center justify-center text-sm font-semibold">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="mb-6">
                                        <div className="flex justify-between mb-2">
                                            ...
                                            <span className="text-sm text-gray-500 flex items-end">raised of ₹{formatCurrency(fundraiser.targetAmount)}</span>
                                        </div>
                                        ...
                                        <div className="flex justify-between items-center mt-2">
                                            ...
                                            <button className="p-2 rounded-full hover:bg-gray-100 text-rose-500 transition-colors">
                                                <Heart size={20} />
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    {/* Donation Form */}
                                    <div>
                                        <h3 className="text-lg font-medium text-gray-800 mb-3">Select amount to donate</h3>
                                        ...
                                        <div className="mb-4">
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="block w-full pl-8 pr-3 py-3 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all"
                                        ...
                                        <button 
                                            ...
                                            className="w-full py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors shadow-md hover:shadow-lg mb-4 flex items-center justify-center"
                                        >
                                            <span className="mr-2" dangerouslySetInnerHTML={{ __html: googlePayLogo }} />
                                            Donate with Google Pay
                                        </button>
                                        
                                        <button className="w-full py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg font-medium transition-colors flex justify-center items-center">
